...
- Envolve o .blue[contato direto] do operador e do instrumento de medição com a .blue[árvore]; e
- São ditas .blue[medidas básicas].
]
]
...
- São exemplos de variáveis com medidas tomadas diretamente na árvore: 
diâmetros, circunferências, espessura de casca, altura de árvores abatidas
