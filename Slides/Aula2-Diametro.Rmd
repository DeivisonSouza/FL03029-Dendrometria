...
.pull-bottom[
<br>
**Parte 3 - Relação Diâmetro e Área Transversal**
]
...
.white[.font200[**Relação Diâmetro e Área Transversal**]]

---
layout: true
<div class="my-header"></div>
<div class="my-footer"><span>Prof. Dr. Deivison Venicio Souza (E-mail: deivisonvs@ufpa.br)&emsp;&emsp;&emsp;&emsp;&emsp;Dendrometria (FL03029) - Medição de Diâmetros de Árvores/Parte 3: Relação Diâmetro e Área Transversal</div>
...
.shadow1[
### Área Transversal (Batista et al., 2014)
.font90[
- A área transversal é a .blue[área da secção transversal] do tronco na altura de .blue[1,30m] do solo;
- A área transversal é simbolizada por $g$ ( $g$ minúsculo );
- É uma medida derivada do diâmetro;
...
$$
\begin{equation*}
g = \pi \left(\dfrac{d}{2}\right)^2\color{green}{\Rightarrow} g = \left(\dfrac{\pi}{4}\right)d^2
\end{equation*}
$$
]
]
...
.font90[
**Importante** `r anicon::faa("exclamation-triangle", colour="red")`: Na prática, especialmente em florestas tropicais, as secções transversais de troncos de árvores não são círculos perfeitos.
]
...
.shadow1[
### Erro da área transversal devido à seção elíptica
]
