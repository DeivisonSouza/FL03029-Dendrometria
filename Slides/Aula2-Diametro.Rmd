...
<br>
O diâmetro da árvore é importante para o cálculo de diversas medidas derivadas:
 * 1 - Cálculo da área transversal (g) da árvore;
...
\end{equation*}
$$
 * 2 - Cálculo da área basal (G) da parcela/unidade de amostra (ou população);
$$
\begin{equation*}
G = \sum_{i=1}^{n}g_i
\end{equation*}
...
.font90[
O diâmetro da árvore é importante para o cálculo de diversas medidas derivadas:
 * 3 - Cálculo do volume da árvore individual; (Por exemplo, a fórmula para calcular o volume de árvores individuais em PMFS na Amazônia)
...
.font90[
O diâmetro da árvore é importante para o cálculo de diversas medidas derivadas:
 * 4 - Cálculo do crescimento (ou incremento) da árvore (ICA, IMA, IP, IPA);
...
<br>
`r anicon::faa("hand-point-right", animate="horizontal")` **Lembre-se:** Precisa-se do diâmetro para calcular o volume!
]
]
