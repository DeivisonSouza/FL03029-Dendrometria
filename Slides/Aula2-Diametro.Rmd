...
.pull-left-4[
| Árvore | CAP (cm) | Espessura de Casca (cm) |
|:--------:|:----------:|:-------------------------:|
| 1      | 78,0     | 2,5                     |
| 2      | 69,0     | 2,0                     |
| 3      | 52,0     | 1,8                     |
...
- **2)** Considerando os diâmetros com casca $\large \left ( d_c \right)$, calcular:<br>
    ...
    d) A área basal  $\large \left ( G \right)$ de duas maneiras diferentes.<br>
    e) A área transversal média  $\large \left ( \bar{g} \right)$ de duas maneiras diferentes.
]
]
