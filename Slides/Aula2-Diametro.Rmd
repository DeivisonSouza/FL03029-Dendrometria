...
.shadow1[
### Diâmetro Equivalente $\large \left ( d_{eq} \right)$
.font90[
...
- **2)** Considerando os diâmetros com casca $\large \left ( d_c \right)$, calcular:<br>
    ...
    c) O diâmetro equivalente $\large \left ( d_{eq} \right)$.<br>
    d) A área basal de duas maneiras diferentes.<br>
    e) A área seccional média de duas maneiras diferentes.
]
]
