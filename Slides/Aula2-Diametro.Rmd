...
.pull-left-4[
```{r, echo=FALSE, out.width='75%', fig.align='center', fig.cap='Suta Mecânica', dpi=600}
...
.pull-left-4[
```{r, echo=FALSE, out.width='75%', fig.align='center', fig.cap='Suta Digital (Suta Mantax Digitech MDII)', dpi=600}
