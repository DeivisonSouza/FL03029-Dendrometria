...
- Assim, para a graduação da régua basta: i) fixar um valor para a distância $L$ (70cm) e atribuir os valores de $d$ à fórmula escolhida ( $\color{orange}{Eq.1}$ ou $\color{brown}{Eq.2}$ ). Em seguida, realizar a operação matemática e obter os valores de $l$. Esses valores devem ser marcados na régua para graduá-la.
]
