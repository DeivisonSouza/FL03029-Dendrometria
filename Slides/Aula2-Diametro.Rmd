...
<br>
## `r anicon::faa("pagelines", animate="horizontal", colour="green")` Medição de Diâmetros `r anicon::faa("pagelines", animate="horizontal", colour="green")` <br> de Árvores
...
.pull-left-2[
```{r tb1, echo=F, eval=T, dpi=600, fig.width=1, fig.height=.55}
library(dplyr)
library(ggplot2)
library(plotly)
...
.white[.font200[**Estatísticas Associadas ao Diâmetro:**] <br> .font150[1 - Média Aritmética <br> 2 - Diâmetro Médio (ou Quadrático)]]
...
.pull-left-4[
| Árvore | c (cm) | Espessura de <br /> Casca (cm) |
|:--------:|:----------:|:-------------------------:|
| 1      | 78,0     | 2,5                     |
| 2      | 69,0     | 2,0                     |
| 3      | 52,0     | 1,8                     |
...
<!-- - **1)** Calcular os diâmetros sem casca $\large \left ( d_{sc} \right)$ de cada árvore. -->
- **2)** Considerando os diâmetros com casca $\large \left ( d_c \right)$, calcular:<br>
    a) A média aritmética dos diâmetros $\large \left ( \bar{d} \right)$. <br>
    b) O diâmetro médio ou diâmetro quadrático $\large \left ( d_g \right)$. <br>
    c) A área transversal média  $\large \left ( \bar{g} \right)$ de duas maneiras diferentes.<br>
...
.blue[a) A média aritmética dos diâmetros] $\large \color{blue}{\left ( \bar{d} \right)}$. <br>
...
<br>
.pull-left-4[
| Árvore | c (cm) | Espessura de <br /> Casca (cm) | d (cm) |
|:--------:|:----------:|:-------------------------:|:----------:|
| 1      | 78,0     | 2,5                     | 24,83     |
| 2      | 69,0     | 2,0                     | 21,96     |
| 3      | 52,0     | 1,8                     | 16,55     |
...
.blue[b) O diâmetro médio ou diâmetro quadrático] $\large \color{blue}{\left ( d_g \right)}$.<br>
...
.blue[c) A área transversal média]  $\large \color{blue}{\left ( \bar{g} \right)}$ .blue[de duas maneiras diferentes.]<br><br>
...
.blue[c) A área transversal média]  $\large \color{blue}{\left ( \bar{g} \right)}$ .blue[de duas maneiras diferentes.]<br>
...
<br>
.pull-left-4[
| Árvore | c (cm) | Espessura de <br /> Casca (cm) | d (cm) | g (m²) |
|:--------:|:----------:|:-------------------------:|:----------:|:------:|
...
.blue[d) A área basal]  $\large \color{blue}{\left ( G \right)}$.<br><br>
