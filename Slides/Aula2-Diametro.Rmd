...
:thinking: embora não tenha conhecimento de valores das sutas de madeira, é razoável acreditar que as sutas de ligas de alumínio tiveram uma agregação de valor.
]

]
]

`r  anicon::cia("thinking.gif", size=3, border=T)`
