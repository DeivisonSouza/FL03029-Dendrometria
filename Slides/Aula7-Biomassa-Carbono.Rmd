...
.font90[
**Biomassa lenhosa**: refere-se à massa da substância madeira (mais casca) de uma árvore. <br><br> `r anicon::faa("hand-point-right", animate="horizontal", colour="orange")` **Massa Seca do Lenho** (sem água).

**Biomassa foliar**: refere-se à massa seca das folhas da árvore.
...
**1)** A biomassa está relacionada aos estoques de macro e micronutrientes da vegetação (.magenta[Higuchi et al., 1998]). Portanto, subsidia a quantificação da ciclagem de nutrientes (.magenta[Silveira et al., 2008]).

**2)** Subsidia estudos relacionados ao **Estoque e Dinâmica de Carbono (C)** nos ecossistemas florestais $\rightarrow$ **Mudanças Climáticas**

**3)** Contribui para compreensão de índices de produtividade e analisar o
