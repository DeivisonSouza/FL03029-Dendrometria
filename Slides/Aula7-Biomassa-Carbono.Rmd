...
[5 - Estudo de Caso: Modelos para Predição da Biomassa](#cbc)
...
<br>
.font80[
- **Biomassa**: É o total de matéria orgânica, morta ou viva, tanto acima quanto abaixo do solo, existente nos organismos (animais ou vegetais) de uma determinada comunidade (Higa et al., 2014).
- **Biomassa florestal**: biomassa de matéria biológica vegetal, viva ou morta, existente na  floresta  ou  apenas  na  fração  arbórea (Sanquetta et al., 2002)
- **Fitomassa**: Esse termo é comumente usado para referir-se a **biomassa florestal** (Sanquetta et al., 2002).
]
]
...
.shadow1[
### Biomassa Florestal (Sanquetta et al., 2002)
<br>

- **Biomassa florestal**: massa de matéria biológica vegetal, viva ou morta, existente na  floresta  ou  apenas  na  fração  arbórea.
- O termo **fitomassa** é comumente usado para referir-se a **biomassa florestal**.
]
...
.shadow1[
### Importância da quantificação da biomassa
<br>
.font90[

**2)** A biomassa está relacionada aos estoques de macro e micronutrientes da vegetação (.magenta[Higuchi et al., 1998]); Portanto, subsidia a quantificação da ciclagem de nutrientes (Silveira et al., 2008).

**1)** Subsidia estudos relacionados ao **Estoque e Dinâmica de Carbono (C)** nos ecossistemas florestais $\rightarrow$ **Mudanças Climáticas**

**2)** Contribui para compreensão de índices de produtividade e analisar o
...
.white[.font200[**Carbono Florestal:**] <br> .font150[Conceito e Importância]]

---
layout: true
<div class="my-header"></div>
<div class="my-footer"><span>Prof. Dr. Deivison Venicio Souza (E-mail: deivisonvs@ufpa.br)&emsp;&emsp;&emsp;&emsp;&emsp;Dendrometria (FL03029) - Biomassa e Carbono Florestal/Parte 1: O carbono Florestal</div>
